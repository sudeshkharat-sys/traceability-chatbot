...
const BASE_ENABLED = ["traceability", "guideline", "part-labeler", "part-labeler-plant", "part-labeler-ev", "z-stage", "pfmea", "qlense"];
...
const ROLE_ALLOWED = {
  ...
  part_labeler_ev:    ["part-labeler-ev", "z-stage", "guideline"],
};
