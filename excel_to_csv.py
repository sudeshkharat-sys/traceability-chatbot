...
INPUT_DIR = Path(r"C:\Users\50014665\GraphRag\Traceability\warranty")   # Windows path (raw string)
OUTPUT_DIR = Path(r"C:\Users\50014665\GraphRag\Traceability\warranty\warranty_csv")  # Windows path (raw string)
